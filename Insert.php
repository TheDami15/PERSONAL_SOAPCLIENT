<?php
/**
 * Script para enviar una solicitud SOAP a un servicio InsertCategoria y procesar la respuesta.
 *
   ...
   <soapenv:Body>
      <ins:InsertCategoriaService soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">
         <InsertCategoria xsi:type=\"ins:InsertCategoria\">
            <usu_nom xsi:type=\"xsd:string\">Laura</usu_nom>
            <usu_ape xsi:type=\"xsd:string\">Verona</usu_ape>
            <usu_correo xsi:type=\"xsd:string\">Verona@gmail.com</usu_correo>
         </InsertCategoria>
